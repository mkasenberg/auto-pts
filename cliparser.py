...
class SmartDefaultsMixin:
    def add_argument(self, *args, **kwargs):
        ...
        action._default_value = default_value
...
class CliParser(SmartDefaultsMixin, argparse.ArgumentParser):
    def __init__(self, iut_modes=None, board_names=None, add_help=True, *args, **kwargs):
        ...
        self.add_argument("--kernel-cpu", "--kernel_cpu", type=str, nargs="+", default=[], iut_param=True,
        ...
        self.add_argument("-t", "--tty-file", type=str, nargs='+', action="extend", default=[],
        ...
        self.add_argument("--net-tty-file", dest='net_tty_file', type=str,
                          nargs='+', action="extend", default=[], iut_param=True,
        ...
        self.add_argument("--device_core", type=str, nargs='+', action="extend", default=[], iut_param=True,
        ...
        self.add_argument("--btpclient-path", "--btpclient_path", type=str, nargs='+',
                          action="extend", default=[], help="Path to btpclient.", iut_param=True)
    ...
    def remodel_args(self, configpy_args, cli_args):
        ...
        for values in zip_longest(*lists.values(), fillvalue=None):
            params = dict(zip(lists.keys(), values))
        ...
        for i, (target, cli_params) in enumerate(zip(targets, cli_targets)):
    ...
    def parse(self, arg_ns=None):
        ...
        for iut_name in args.iut_targets_args:
            ...
            if _args.tty_baudrate is None:
                _args.tty_baudrate = SERIAL_BAUDRATE
